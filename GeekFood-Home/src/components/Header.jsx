...
const Header = () => {
  return (
    <div className="pb-20">
      <div className=" w-full fixed flex justify-around items-center bg-[#fffffffd] text-[#444444] p-3">
        <div className="flex justify-center items-center gap-3">
          <img src={LOGO_URl} alt="" className="" />
          <a className="text-2xl font-bold cursor-pointer">GeekFoods</a>
        </div>

        <ul className="flex gap-8 text-xl font-medium items-center cursor-pointer">
